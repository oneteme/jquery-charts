# Pilotage — externalisation View (table + charts)

> Fichier vivant. A mettre a jour au fil du developpement.
> Reference contexte global: docs/contexte-view-externalisation.md
...
- [x] Finaliser la vision globale du perimetre View
...
- [x] Rendre View disponible sur jquery-highcharts et jquery-apexcharts (phase 4 basique)
...
- [ ] Valider que View peut remplacer DynamicChartComponent dans kpi-global sans forcer d'usage de ces options pour les autres consommateurs
...
> Contexte: la branche kpi-global implémente un menu View ad-hoc sur les charts (DynamicChartComponent).
