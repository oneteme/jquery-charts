...
export class AppComponent {
  ...
  onChartTypeSelected(type: string) {
    ...
    switch(selectedType) {
        ...
        this.visibleChartTypes = [{
          ...
          rows: [
            [
              ...
              { config: this.pieExample2.config, data: this.pieExample2.data },
              { config: this.pieExample3.config, data: this.pieExample3.data }
            ],
            [
              { config: this.pieExample4.config, data: this.pieExample4.data },
              { config: this.pieExample5.config, data: this.pieExample5.data },
              { config: this.pieExample6.config, data: this.pieExample6.data }
            ],
            [
              { config: this.pieExample7.config, data: this.pieExample7.data },
              { config: this.pieExample8.config, data: this.pieExample8.data },
              { config: this.pieExample9.config, data: this.pieExample9.data }
            ]
          ]
        }];
        break;
        ...
        this.visibleChartTypes = [{
          ...
          rows: [
            [
              ...
              { config: this.barExample2.config, data: this.barExample2.data },
              { config: this.barExample3.config, data: this.barExample3.data }
            ],
            [
              { config: this.barExample4.config, data: this.barExample4.data },
              { config: this.barExample5.config, data: this.barExample5.data },
              { config: this.barExample6.config, data: this.barExample6.data }
            ],
            [
              { config: this.barExample7.config, data: this.barExample7.data },
              { config: this.barExample8.config, data: this.barExample8.data },
              { config: this.barExample9.config, data: this.barExample9.data }
            ],
            [
              { config: this.barExample10.config, data: this.barExample10.data }
            ]
          ]
        }];
        break;
      ...
      case 'Line Chart':
        this.visibleChartTypes = [{
          ...
          rows: [
            [
              { config: this.lineExample.config, data: this.lineExample.data },
              { config: this.lineExample2.config, data: this.lineExample2.data },
              { config: this.lineExample3.config, data: this.lineExample3.data }
            ],
            [
              { config: this.lineExample4.config, data: this.lineExample4.data },
              { config: this.lineExample5.config, data: this.lineExample5.data },
              { config: this.lineExample6.config, data: this.lineExample6.data }
            ],
            [
              { config: this.lineExample7.config, data: this.lineExample7.data },
              { config: this.lineExample8.config, data: this.lineExample8.data },
              { config: this.lineExample9.config, data: this.lineExample9.data }
            ]
          ]
        }];
        break;
      ...
      case 'Treemap Chart':
        this.visibleChartTypes = [{
          ...
          rows: [
            [
              { config: this.treemapExample.config, data: this.treemapExample.data },
              { config: this.treemapExample2.config, data: this.treemapExample2.data },
              { config: this.treemapExample3.config, data: this.treemapExample3.data }
            ]
          ]
        }];
        break;
      ...
      case 'Heatmap Chart':
        this.visibleChartTypes = [{
          ...
          rows: [
            [
              { config: this.heatmapExample.config, data: this.heatmapExample.data }
            ]
          ]
        }];
        break;
      ...
      case 'Range Chart':
        this.visibleChartTypes = [{
          ...
          rows: [
            [
              { config: this.rangeExample.config, data: this.rangeExample.data }
            ]
          ]
        }];
        break;
      ...
      case 'Funnel Chart':
        this.visibleChartTypes = [{
          ...
          rows: [
            [
              { config: this.funnelExample.config, data: this.funnelExample.data }
            ]
          ]
        }];
        break;
